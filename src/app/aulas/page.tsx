...
function AulasPageInner() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#080808', fontFamily:"'DM Sans', sans-serif", color:'#f0f0f0' }}>
      ...
      <AvisoPopupPinheiros unidadeId={unidadeId} />
              ...
              {planosDisponiveis.length===0 ? (
                ...
                return (
                  <div key={p} onClick={() => setTipoCredito(p)}
                    ...
                    <div style={{ flex:1 }}><div style={{ fontSize:14, fontWeight:600, color:tipoCredito===p?'#fff':'#888' }}>{saldoParaData()[p]?.nome_pacote || label}</div></div>
