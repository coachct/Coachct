...
const nav = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Cancelamentos',    href: '/admin/cancelamentos' },
  ...
  },
  {
    ...
    icon: Activity,
    children: [
      { label: 'Saúde das Integrações', href: '/admin/saude' },
    ],
  },
  {
    label: 'Clientes',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Loja · Produtos e estoque', href: '/admin/loja' },
      { label: 'Loja · Vendas',             href: '/admin/loja/vendas' },
