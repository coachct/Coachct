    ...
    <div>
      ...
      <div className="card">
        {filtradas.length === 0 ? (
          ...
          <div>
            {/* Celular: um cartão por avaliação (sem rolar pro lado). A tabela aparece a partir de md. */}
                ...
                <div key={a.id} className="py-3 first:pt-0">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="text-sm font-semibold text-gray-800">
                        ...
                        {a.coach_nome ? <span className="font-normal text-gray-500"> · {a.coach_nome}</span> : null}
                      </div>
                    ...
                    <div className="text-right text-xs text-gray-500 whitespace-nowrap">
                      ...
                      <div className="text-gray-400">avaliada {dataHoraBR(a.criado_em)}</div>
                    </div>
                  </div>
                  <div className="mt-2 grid grid-cols-4 gap-1.5 text-center">
                    {([
                      ['Aula', a.nota_aula],
                      ['Prof.', a.nota_professor],
                      ['Música', a.nota_musica],
                      ['Ambiente', a.nota_ambiente],
                    ] as [string, number | null][]).map(([rotulo, valor]) => (
                      <div key={rotulo} className="bg-gray-50 rounded-lg py-1.5">
                        <div className="text-[10px] text-gray-400 uppercase tracking-wide">{rotulo}</div>
                        <div className="text-sm"><Nota valor={valor} /></div>
                      </div>
                    ))}
                  </div>
                  <div className="mt-2 text-sm text-gray-500">
                    ...
                    {a.cliente_id && a.clientes?.nome ? (
                      <button
                        ...
                        className="text-left text-gray-700 underline decoration-gray-200"
                      >
                        {a.clientes.nome}
                      </button>
                    ) : (
                  ...
                  {a.comentario && (
                    <div className="mt-2 bg-gray-50 rounded-lg px-3 py-2.5">
                      ...
                      <div className="text-sm text-gray-700 whitespace-pre-wrap break-words leading-relaxed">{a.comentario}</div>
                      {respostaControle(a)}
                    </div>
                  )}
                </div>
