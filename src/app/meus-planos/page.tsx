        ...
        <div style={{ position: 'fixed', inset: 0, background: '#000000dd', zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
          <div style={{ background: '#111', border: '1px solid #333', borderRadius: 20, width: '100%', maxWidth: 520, maxHeight: '90vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '1rem 1.5rem' }}>
              ...
              <pre style={{ fontSize: 12, color: '#777', lineHeight: 1.8, whiteSpace: 'pre-wrap', fontFamily: "'DM Sans', sans-serif" }}>{CONTRATO_AGREGADORES}</pre>
            </div>
            <div style={{ padding: '1rem 1.5rem', borderTop: '1px solid #222' }}>
              <div style={{ marginBottom: '1rem' }}>
                ...
                <input type="text" value={nomeAceite} onChange={e => setNomeAceite(e.target.value)} placeholder="Nome Sobrenome"
                  style={{ width: '100%', background: '#0a0a0a', border: `1px solid ${nomeAceite.length > 3 ? ACCENT + '66' : '#333'}`, borderRadius: 8, padding: '0.65rem 1rem', color: '#fff', fontSize: 14, fontFamily: "'DM Sans', sans-serif", outline: 'none' }} />
              </div>
