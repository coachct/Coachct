            ...
            {clienteBloqueado && !temCobrancaPendente && (
              <div style={{ background: '#1a1000', border: `2px solid ${AMARELO}`, borderRadius: 16, padding: '1.5rem', marginBottom: '1.5rem' }}>
                ...
                <div style={{ fontSize: 14, color: '#ddd', lineHeight: 1.7, marginBottom: '1rem' }}>
                  {cliente?.motivo_bloqueio || 'Há uma multa de falta a regularizar. Cadastre ou atualize seu cartão para acertar o pagamento e liberar novos agendamentos.'}
                </div>
                <button onClick={() => router.push('/cadastrar-cartao')}
                  style={{ width: '100%', background: AMARELO, color: '#000', border: 'none', borderRadius: 10, padding: '0.85rem 1.25rem', fontWeight: 700, fontSize: 14, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" }}>
