...
9.1 O Coach CT é uma metodologia coletiva de treinos elaborada pela Coordenação, ainda que executada em formato 1×1 (um coach por aluno na sessão). Por se tratar de programa padronizado mensalmente, o cliente não possui direito de substituir exercícios, alterar séries, repetições ou demais parâmetros do treino, devendo seguir integralmente o programa conforme passado pelo coach responsável.
...
9.7 O cancelamento de reservas do Coach CT deve ser realizado com antecedência mínima de 12 (doze) horas em relação ao horário agendado. Excepcionalmente, será permitido cancelamento com antecedência mínima de 3 (três) horas caso exista fila de espera ativa para o horário, hipótese em que a vaga será automaticamente realocada ao próximo cliente da fila. Após esses prazos, não será possível cancelar a reserva, e o não comparecimento será tratado como no-show, sujeitando o cliente à multa prevista na cláusula 8.

9.8 As sessões do Coach CT devem ser realizadas obrigatoriamente no horário e data agendados. Não há reposição, transferência ou aproveitamento da sessão em data distinta da reserva original. O cancelamento, quando feito dentro do prazo previsto na cláusula 9.7, libera o cliente para nova reserva sem custos adicionais.
...
10.4 A Just CT poderá alterar as condições deste Termo mediante comunicação prévia de 30 (trinta) dias aos clientes ativos, através dos canais oficiais (e-mail, WhatsApp ou comunicação no Studio). A continuidade do uso dos serviços após o prazo será considerada aceite tácito das novas condições.
...
**12. ACEITE DIGITAL E ATIVAÇÃO**

12.1 Este Termo deve ser aceito digitalmente pelo cliente antes da primeira utilização dos serviços. A ativação inicial pode ser realizada pela recepção em nome do cliente para fins de validação imediata, mediante consentimento verbal.

12.2 Caso o cliente não realize o aceite digital no prazo de 7 (sete) dias corridos contados da ativação do plano, novas reservas serão bloqueadas até a regularização.

12.3 O aceite digital substitui, para todos os fins legais, a assinatura física do contrato, sendo registrados no sistema: data, hora, IP de origem e nome completo digitado pelo cliente.

**13. FORO**

Fica eleito o foro da Comarca de São Paulo/SP para dirimir quaisquer dúvidas ou controvérsias decorrentes deste Termo.`
